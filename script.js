...
$(document).ready(function (event){
  ...
  $('html, body').animate({
      scrollTop: $('#section_strategy1').offset().top
  }, 500);
...
// $(".img_alart_button").click(function(){
...
//   $('body').scrollTo('#section_strategy1'); 
...
$(window).mousemove(function(evt){
  ...
  //更新一些移動景物的位置
  $(".index_mountain").css("transform","translateX("+x/-20+50+"px)")
